    ...
    <div class="container">
        ...
        <input type="hidden" name="token" value="{{ $request->route('token') }}">
                                    ...
                                    <div class="form-group">
                                        <input id="email" type="email" name="email" value="{{old('email', $request->email)}}" required autofocus autocomplete="username" placeholder="Email *" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        name="password_confirmation" required autocomplete="new-password" placeholder="Confirm you password *" />
                                    </div>
                                    <div class="form-group">
